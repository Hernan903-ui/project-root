...
export const exportToExcel = (data, columns, fileName = 'reporte.xlsx') => {
  ...
  // Mensaje informativo
  console.log('Exportación a Excel simulada mediante CSV. Para una integración real, considere usar bibliotecas como xlsx o exceljs.');
};
...
export const generateReport = (format, title, data, columns, fileName) => {
  switch (format.toLowerCase()) {
    ...
    case 'csv':
      return exportToCSV(data, columns, fileName || 'reporte.csv');
    case 'excel':
      return exportToExcel(data, columns, fileName || 'reporte.xlsx');
    case 'print':
